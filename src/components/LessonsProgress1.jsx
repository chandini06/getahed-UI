...
import './LessonsProgress1.css';

const LessonsProgress1 = () => {
  const total = 7;
  const completed = 3;
  const inProgress = 3;
  const notStarted = 1;
  ...
  return (
    <div className="lessons-progress-wrapper1">
      <div className="lessons-progress-header1">
      ...
      <div className="progress-legend1">
...
export default LessonsProgress1;